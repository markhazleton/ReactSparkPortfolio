...
describe('ProjectDataSchema', () => {
  ...
  it('should reject negative project ID', () => {
    ...
    expect(() => ProjectDataSchema.parse(invalidProject)).toThrow('Project ID must be a positive integer');
  });
  ...
  it('should reject empty image path', () => {
    ...
    expect(() => ProjectDataSchema.parse(invalidProject)).toThrow('Project image path cannot be empty');
  });
  ...
  it('should reject empty project description', () => {
    ...
    expect(() => ProjectDataSchema.parse(invalidProject)).toThrow('Project description cannot be empty');
  });
  ...
  it('should reject invalid URL in project link', () => {
    ...
    expect(() => ProjectDataSchema.parse(invalidProject)).toThrow('Project link must be a valid URL');
  });
...
describe('Project Class', () => {
  ...
  describe('formatTitle', () => {
    it('should return title when valid', () => {
      const project = new Project(1, '/img/test.png', 'Test Project', 'Description', 'https://example.com');
  ...
  describe('formatDescription', () => {
    it('should return description when valid', () => {
      const project = new Project(1, '/img/test.png', 'Title', 'Test Description', 'https://example.com');
    ...
    it('should return description as-is when non-empty after trim', () => {
      const project = new Project(1, '/img/test.png', 'Title', '  Description  ', 'https://example.com');
