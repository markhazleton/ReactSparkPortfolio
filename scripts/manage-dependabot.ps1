...
$MediumPRs = @(
    @{Number=28; Title="Bump qs in /admin"; Location="admin"; Reason="Bug fixes"}
...
$LowPRs = @(
    @{Number=19; Title="Bump express in /admin"; Location="admin"; Reason="Minor update"}
    @{Number=17; Title="Bump body-parser in /admin"; Location="admin"; Reason="Patch update"}
)
