      ...
      <div className="row">
        <div className="col-lg-8 mx-auto">
          <div className={`card shadow-sm ${isDark ? "border-secondary" : "border-0"} mb-4`}>
            <div
              className={`card-header ${isDark ? "bg-dark text-light" : "bg-primary text-white"}`}
            >
            ...
            <div className={`card-body ${isDark ? "bg-dark text-light" : ""}`}>
              <form>
                <div className="input-group mb-3">
                  <span
                    className={`input-group-text ${isDark ? "bg-dark text-light border-secondary" : "bg-light"}`}
                  >
                    <Search />
                  </span>
                  <input
              ...
              {recentSearches.length > 0 && (
                <div className="mb-4">
                  <small
                    className={`${isDark ? "text-light-emphasis" : "text-secondary"} d-block mb-2`}
                  >
                    Recent searches:
                  </small>
                ...
                <>
                  {initialLoading ? (
                    <div className="text-center my-5">
                      ...
                      <p className={`mt-3 ${isDark ? "" : "text-dark"}`}>
                        Loading weather for default cities...
                      </p>
                    </div>
                  ) : (
                    <div className="mt-4">
                      <h3 className={`h5 mb-3 ${isDark ? "" : "text-dark"}`}>
                        ...
                        {Object.keys(initialWeatherData).map((cityName) => {
                          ...
                          return (
                            <div className="col-md-6 mb-4" key={cityName}>
                              <div
                                className={`card h-100 ${isDark ? "bg-dark text-light border-primary" : "border-primary"}`}
                              >
                                <div
                                  className={`card-header ${isDark ? "bg-dark border-primary" : "bg-primary"}`}
                                >
                                  ...
                                  <div className="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                      <div className={isDark ? "" : "text-dark"}>
                                        {data.currentConditions.conditionsDescription}
                                      </div>
                                      <div
                                        className={`small ${isDark ? "text-light-emphasis" : "text-secondary"}`}
                                      >
                                        Feels like{" "}
                                        {data.currentConditions.feelsLike?.toFixed(1) || "--"}°F
                                      </div>
                                    </div>
                                  </div>
                                  <div className="row g-2 small">
                                    <div className="col-6">
                                      <div className="d-flex align-items-center">
                                        <Droplet
                                          className={`${isDark ? "text-light" : "text-primary"} me-1`}
                                        />
                                        <div>
                                          <div
                                            className={
                                              isDark ? "text-light-emphasis" : "text-secondary"
                                            }
                                          >
                                            Humidity
                                          </div>
                                    ...
                                    <div className="col-6">
                                      <div className="d-flex align-items-center">
                                        ...
                                        <div>
                                          ...
                                          <div className={isDark ? "" : "text-dark"}>
                                            {data.currentConditions.windSpeed.toFixed(1)} mph
                                          </div>
                                        </div>
                                      </div>
                                    </div>
                                ...
                                <div
                                  className={`card-footer border-top-0 text-center ${isDark ? "bg-dark" : "bg-white"}`}
                                >
                                  <button
              ...
              {weatherData && (
                <div className="mt-4">
                  <div
                    className={`card ${isDark ? "bg-dark text-light border-primary" : "border-primary"} mb-4`}
                  >
                    <div
                      className={`card-header ${isDark ? "bg-dark border-primary" : "bg-primary"}`}
                    >
                      ...
                      <div className="row">
                        <div className="col-md-6 mb-4 mb-md-0">
                          <div className="d-flex align-items-center mb-4">
                            ...
                            <div>
                              <div className={`h5 ${isDark ? "" : "text-dark"}`}>
                                {weatherData.currentConditions.conditionsDescription}
                              </div>
                              <div className={isDark ? "text-light-emphasis" : "text-secondary"}>
                                Feels like{" "}
                                {weatherData.currentConditions.feelsLike?.toFixed(1) || "--"}°F
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="row g-3">
                            <div className="col-6">
                              <div className="d-flex align-items-center">
                                <Droplet
                                  className={`${isDark ? "text-light" : "text-primary"} me-2`}
                                />
                                <div>
                                  <div
                                    className={`small ${isDark ? "text-light-emphasis" : "text-secondary"}`}
                    ...
                    <div
                      className={`card-footer ${isDark ? "bg-dark border-secondary" : "bg-white"} small`}
                    >
          ...
          <div
            className={`card shadow-sm ${isDark ? "bg-dark text-light border-secondary" : "border-0"} mb-4`}
          >
            <div className={`card-header ${isDark ? "bg-dark border-secondary" : "bg-light"}`}>
              <h2
                className={`h5 mb-0 d-flex align-items-center ${isDark ? "text-light" : "text-dark"}`}
              >
            ...
            <div className="card-body">
              ...
              <p className={isDark ? "" : "text-dark"}>
                Our weather forecast tool provides real-time weather data for cities across the
                globe. Simply enter a city name or zip code in the search box above to get instant
                access to current weather conditions. Our default cities include Dallas and Wichita,
                but you can search for any location worldwide.
              </p>

              <h3 className={`h6 ${isDark ? "" : "text-dark"}`}>Data Source</h3>
              <p className={isDark ? "" : "text-dark"}>
                The weather data displayed on this page is powered by the OpenWeather API, accessed
                through our secure backend service. When you search for a location, a request is
                sent to our secured WebSpark API service, which then fetches the most up-to-date
                weather information while keeping API credentials protected.
              </p>
              ...
              <p className={isDark ? "" : "text-dark"}>
                This weather forecast tool is built using React with TypeScript. It utilizes React
                hooks for state management and localStorage for persisting your recent searches. The
                interactive map is implemented using a custom MapComponent that pinpoints the exact
                coordinates of the queried location. All weather data is updated in real-time
                whenever you search for a new location or refresh an existing one.
              </p>

              <h3 className={`h6 ${isDark ? "" : "text-dark"}`}>Usage Tips</h3>
              <p className={isDark ? "" : "text-dark"}>
                To get the most accurate forecast, enter a specific city name. You can also include
                the state or country for more precise results (e.g., "Dallas, TX" or "Paris,
                France"). Your recent searches are saved for convenience, allowing you to quickly
                check weather updates for your frequently visited locations.
              </p>

              <div className={`mt-4 border-top pt-3 ${isDark ? "border-secondary" : ""}`}>
                <small className={isDark ? "text-light-emphasis" : "text-secondary"}>
                  Last updated: April 14, 2025. Weather data is refreshed each time you perform a
                  search or click the refresh button.
                </small>
              </div>
            </div>
          </div>
